...
<h2>Четвертый спринт:</h2>
<ol>
  <li>Добавить фоновый процесс обновления состояния (8)</li>
  <li>Реализовать смену имени питомца (3)</li>
  <li>Добавить изменение изображения в зависимости от состояния питомца (5)</li>
</ol>
<h2>Пятый спринт:</h2>
<ol>
  <li>Создать инвентарь с одеждой (8)</li>
  <li>Реализовать логику сна (5)</li>
  <li>Добавить кастомизацию питомца (5)</li>
</ol>
